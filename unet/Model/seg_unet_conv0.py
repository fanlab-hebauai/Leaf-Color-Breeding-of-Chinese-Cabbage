...
def unet(pretrained_weights = None, input_size = (608, 608, 5), classNum = 2, learning_rate = 1e-5):
    ...
    # conv1 = ca_block(conv1,ratio = 8, name = "ca_block_1")
    conv11 = cbam_block(conv1, ratio=8, name="cbam_block_11")
    ...
    # conv2 = ca_block(conv2,ratio = 8, name = "ca_block_2")
    conv22 = ca_block(conv2,ratio = 8, name = "ca_block_22")
    ...
    # conv3 = ca_block(conv3,ratio = 8, name = "ca_block_3")
    # conv33 = ca_block(conv3,ratio = 8, name = "ca_block_33")
    ...
    conv4 = ca_block(conv4,ratio = 8, name = "ca_block_4")
    #  Dropout正规化，防止过拟合
    ...
    conv5 = ca_block(conv5,ratio = 8, name = "ca_block_5")
    ...
    # conv6 = ca_block(conv6,ratio = 8, name = "ca_block_6")
    ...
    # conv7 = ca_block(conv7,ratio = 8, name = "ca_block_7")
    ...
    # conv8 = ca_block(conv8,ratio = 8, name = "ca_block_8")
    ...
    # conv9 = ca_block(conv9,ratio = 8, name = "ca_block_9")
    # conv9 = cbam_block(conv9, ratio=8, name="cbam_block_9")
    # conv9 = eca_block(conv9,b=1, gamma=2, name="eca_block_9")
