...
import cv2
# dataset = gdal.Open("E:\\zj\\mutispectralunet\\DATAnew\\validation\\imageall8\\16.tif")
# width = dataset.RasterXSize
# print(height)
# height = dataset.RasterYSize
# train_image_path="E:\\zj\\mutispectralunet\\DATAnew\\validation\\imageall8"
# imageList = os.listdir(train_image_path)
# img =gdal.Open(train_image_path + "\\" + imageList[0])
# # dataset = gdal.Open(fileName)
# width = img.RasterXSize
# height = img.RasterYSize
# GdalImg_data = img.ReadAsArray(0, 0, width, height)
# print(imageList )
#  获取颜色字典
