...
from tensorflow.keras.layers import Input, MultiHeadAttention, BatchNormalization, Conv2D, MaxPooling2D, Dropout, concatenate,  UpSampling2D
...
def unet(pretrained_weights = None, input_size = (256, 256, 5), classNum = 2, learning_rate = 1e-5):
    ...
    attention = MultiHeadAttention(num_heads=2, key_dim=32)(conv1, conv1)
    #  对于空间数据的最大池化
    ...
    try:
        merge9 = concatenate([attention,up9],axis = 3)
    except:
